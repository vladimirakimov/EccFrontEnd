...
import { ACTIONS as LIST_ACTIONS } from '../../../../redux/buttonPortFiltersList.actions'
...
class ButtonFiltersTab extends React.PureComponent {
  constructor (props) {
    super(props)
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(ButtonFiltersTab))
